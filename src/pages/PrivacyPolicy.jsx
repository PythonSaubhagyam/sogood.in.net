      ...
      <Container maxW={"container.xl"} mb={4} px={0} centerContent>
        ...
        <VStack maxW={"6xl"} my={8} px={6}>
          <Box color={"text.300"} textAlign={"justify"}>
            ...
            collect on the Suryan Organic website (<b>www.sogood.in.net</b>) further
            ...
            provided to <b>www.sogood.in.net</b> It does not govern any other
            ...
            <br />
            In general, you can visit the <b>www.sogood.in.net</b> without telling us
